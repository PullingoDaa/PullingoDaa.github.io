(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                ...
                HomeComponent.prototype.Showing = function () {
                    this.showing = true;
                    this.coming = false;
                };
                HomeComponent.prototype.Coming = function () {
                    this.showing = false;
                    this.coming = true;
                };
                //Movie_setting
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(userService, router, dialogRef, snackBar) {
                ...
                LoginComponent.prototype.loginUser = function (user) {
                    var _this = this;
                    this.userService.loginUser(user).subscribe(function (response) {
                        if (response) {
                            if (response.token) {
                                ...
                                if (response.user.role === 'ADMIN') {
                                    ...
                                    _this.snackBar.open("Admin Login Successfully", "close", {
                                        duration: 2000,
                                    });
                                }
                                else {
                                    ...
                                    _this.dialogRef.closeAll();
                                    _this.snackBar.open("User Login Successfully", "close", {
                                        duration: 2000,
                                    });
                                }
                            }
                            ...
                            _this.snackBar.open(response, "close", {
                                duration: 2000,
                            });
                        }
                    }, function (error) {
                        _this.snackBar.open("Username & Password is incorrect", "close", {
                            duration: 2000,
                        });
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignupComponent = /** @class */ (function () {
                ...
                SignupComponent.prototype.saveUser = function (user, userForm) {
                    user.enabled = true;
                    this.userService.saveUser(user).subscribe(function (respose) {
                        if (respose) {
                            console.log(respose);
                            userForm.reset();
                        }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.loginUser = function (user) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ Authorization: 'Basic ' + btoa(user.email + ':' + user.password) });
                    return this.httpClient.post("http://localhost:8080/login", user, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (userData) {
